...
export interface CCIPReceiver_UnsafeInterface extends utils.Interface {
  functions: {
...
export interface CCIPReceiver_Unsafe extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CCIPReceiver_UnsafeInterface;
